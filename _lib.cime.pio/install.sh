...
cmake -S src -B bld -DCMAKE_C_COMPILER=mpicc -DCMAKE_Fortran_COMPILER=mpif90 -DCMAKE_INSTALL_PREFIX=bld -DCMAKE_MODULE_PATH=/p/project/XLM/_lib.cime.pio/_cmake2
